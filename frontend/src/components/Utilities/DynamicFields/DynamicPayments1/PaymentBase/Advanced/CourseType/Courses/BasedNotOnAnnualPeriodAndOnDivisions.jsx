    ...
    <>
      {paymentState[index].paymentBase.courseBasedPayment.divisions.map(
        (topDivision, divisionIndex) => (
          <div key={divisionIndex} className="field-subgroup-containers">
            <div className="flex-ccc">
              <div>
                {majorDivisonSelected && subDivisionSelected ? (
                  topDivision.map((division, divisionIdx) => (
                    <div key={divisionIdx} className="mt-1">
                        ...
                        {division.educationalSubDivision.map(
                          (subDivision, subDivisionIndex) => (
                            <div
                              ...
                              className="inputs field-subgroup-containers"
                            >
                              <section>
                ...
                majorDivisonSelected && !subDivisionSelected ? (
                  <>
                    {topDivision.map((division, divisionIndex) => (
                ...
                !majorDivisonSelected && subDivisionSelected ? (
                  ...
                  <>
                    ...
                    <label htmlFor="" className="pt-1 pb-1">
                      Wrong Annual Period & Division settings. Choose Major or
                      Sub Divisions.
                    </label>
                  </>
                )}
